            ...
            <div class="modal-body">
                <div class="login-dark">
                    <form method="POST" autocomplete="on" action="{{ route('student.create') }}" style="background: rgba(30,40,51,0.79);max-width: 600px;padding: 0;border-top-left-radius: 0;border-top-right-radius: 0;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;">
                        ...
                        <div class="row">
                            <div class="col">
                                <div style="padding: 40px;"><h1>Bienvenid@ a ExpoSis ! <br> Empecemos por registrarte . . . !</h1>
                                    <div class = "mt-3">
                                        <div class="row">
                                            <div class="col">
                                                <div>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary d-block w-100" type="submit" style="background: rgba(33,74,128,0);color: #128400;font-weight: bold;font-family: VT323, monospace;font-size: 20px;padding: 6px;border: 3px dashed #128400 ;">Registrarme</button>
                                    </div>
                                </div>
                            </div>
                        </div>
